...
<html>
  <head>
    ...
    <title>Welcom maak een account aan om te beginnen!
    </title>
  ...
  <header>
    <div class="lettertype">
      <ul>
        <li>
          <a href="welcome.php"target="_blank">Home pagina
          </a>
        </li>
        <li>
          <a href="register.php">Registreer
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="logout.php"target="_blank">Uitloggen
          </a>
        <li>
        <li>
          <a href="blog/Blog.html"target="_blank">Blog
          </a>
        </li>
        <li>
          <a href="nieuws/Nieuws.html"target="_blank">Nieuws
          </a>
        </li>
        <li>
          <a href="mijn projecten/Mijnprojecten.html">Mijn projecten
          </a>
        </li>
      </ul>
    </div>
...
?>
    <div class="sign-up-form">
      ...
      <form method="post" class="form-horizontal">
        ...
        <div class="col-sm-offset-3 col-sm-9 m-t-15">
          Heb je al een account log dan hieronder in! 
          <a href="index.php"class="input-box" Account
             </p>
          </a>
        </div>
    </div>
